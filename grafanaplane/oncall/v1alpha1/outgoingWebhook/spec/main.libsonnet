{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'OutgoingWebhookSpec defines the desired state of OutgoingWebhook' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'OutgoingWebhookSpec defines the desired state of OutgoingWebhook' } },
