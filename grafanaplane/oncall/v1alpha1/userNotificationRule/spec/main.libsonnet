{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'UserNotificationRuleSpec defines the desired state of UserNotificationRule' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'UserNotificationRuleSpec defines the desired state of UserNotificationRule' } },
