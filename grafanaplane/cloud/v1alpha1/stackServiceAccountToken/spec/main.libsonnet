{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'StackServiceAccountTokenSpec defines the desired state of StackServiceAccountToken' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'StackServiceAccountTokenSpec defines the desired state of StackServiceAccountToken' } },
