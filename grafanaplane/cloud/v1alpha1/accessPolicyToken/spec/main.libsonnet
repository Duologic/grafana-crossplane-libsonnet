{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'AccessPolicyTokenSpec defines the desired state of AccessPolicyToken' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'AccessPolicyTokenSpec defines the desired state of AccessPolicyToken' } },
