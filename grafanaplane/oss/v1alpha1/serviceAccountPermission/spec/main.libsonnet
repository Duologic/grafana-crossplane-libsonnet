{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'ServiceAccountPermissionSpec defines the desired state of ServiceAccountPermission' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'ServiceAccountPermissionSpec defines the desired state of ServiceAccountPermission' } },
