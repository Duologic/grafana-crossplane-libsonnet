{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'OrganizationPreferencesSpec defines the desired state of OrganizationPreferences' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'OrganizationPreferencesSpec defines the desired state of OrganizationPreferences' } },
