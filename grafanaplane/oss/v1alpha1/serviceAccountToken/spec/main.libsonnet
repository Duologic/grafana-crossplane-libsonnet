{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'ServiceAccountTokenSpec defines the desired state of ServiceAccountToken' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'ServiceAccountTokenSpec defines the desired state of ServiceAccountToken' } },
