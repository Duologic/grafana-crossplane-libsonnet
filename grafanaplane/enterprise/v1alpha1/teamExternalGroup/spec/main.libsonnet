{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'TeamExternalGroupSpec defines the desired state of TeamExternalGroup' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'TeamExternalGroupSpec defines the desired state of TeamExternalGroup' } },
